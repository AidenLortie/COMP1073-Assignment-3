...
form.addEventListener('submit', function (event) {
    ...
    const cheeses = Array.from(document.querySelectorAll('input[name="cheese"]:checked')).map(checkbox => checkbox.value);
    ...
    // set the outputed string as the innerHTML of the section
